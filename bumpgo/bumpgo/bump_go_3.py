...
class BumpGo(Node):
    ...
    def control_callback(self):
        ...
        #Resvio que pasa si el estado es Back, mando velocidad negativa por 2 s
            ...
            #encontrar en que ángulo se encuentra la mayor distancia
            max_dist = max(self.last_scan.ranges)
            for i, obj in enumerate(self.last_scan.ranges):
                if obj == max_dist:
                    theta = -1.91986+0.005774*i
                    self.SPEED_ANGULAR = theta/2
